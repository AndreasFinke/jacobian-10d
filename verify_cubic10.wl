...
images = (Together /@ (g /. Thread[v -> #])) & /@ points;

{
  "determinant" -> Factor[Det[Table[D[g[[i]], v[[j]]], {i, 10}, {j, 10}]]],
  "points are distinct" -> (Length[DeleteDuplicates[points]] == 3),
  "images" -> images,
  "all images agree" -> (SameQ @@ images)
}
